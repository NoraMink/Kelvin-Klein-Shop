...
?>
        <div id="form_register">
            <h2><font size="5" color="White" face="century gothic">Форма регистрации</font></h2>
 
            <form action="register.php" method="post" name="form_register">
                <table>
                    <tbody><tr>
                        <td> <font size="2" color="White" face="century gothic">Имя:</font> </td>
                        <td>
                    ...
                    <tr>
                        <td> <font size="2" color="White" face="century gothic">Фамилия:</font> </td>
                        <td>
...
?>
        <div id="authorized">
            <h2><font size="2" color="White" face="century gothic">Вы уже зарегистрированы</font></h2>
        </div>
<?php
    }
